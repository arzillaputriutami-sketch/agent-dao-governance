"""DAO Governance Radar multi-agent reasoning core.
...
PROJECT_NAME = 'DAO Governance Radar'
DOMAIN = 'governance intelligence'
AUDIENCE = 'DAO contributors and delegates'
AGENT_ROLES = ['Proposal Summarizer', 'Delegate Bloc Mapper', 'Quorum Forecaster', 'Execution Risk Reviewer', 'Comms Brief Writer']
SIGNALS = ['quorum_gap_pct', 'delegate_concentration', 'treasury_impact_usd', 'execution_delay_days', 'sentiment_shift']
SCENARIOS = ['treasury spend vote', 'protocol parameter change', 'delegate coalition swing']
