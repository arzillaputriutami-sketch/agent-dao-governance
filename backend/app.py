"""FastAPI boundary for DAO Governance Radar."""
...
if FastAPI:
    ...
    def list_proposals():
        return {"status": "ok", "endpoint": "/api/proposals", "project": PROJECT_NAME, "demo": True}

    @app.get("/api/proposals/{id}")
    def proposal_detail():
        return {"status": "ok", "endpoint": "/api/proposals/{id}", "project": PROJECT_NAME, "demo": True}

    @app.get("/api/voting/power")
    def voting_power():
        return {"status": "ok", "endpoint": "/api/voting/power", "project": PROJECT_NAME, "demo": True}
else:
    app = None
