# Reviewer Guide — DAO Governance Copilot
...
## Product objective
Review governance proposal risk and voting implications.
...
print(run_pipeline_sync("DAO Governance Copilot", {"subject":"dao_vote reviewer smoke"}))
PY
```
